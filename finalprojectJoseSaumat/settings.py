"""
Django settings for finalprojectJoseSaumat project.
...
# Makes it easy for Django to read .env files
...
SECRET_KEY = 'django-insecure-#ubvy(4#40v+117@f(d=y@esi6l1az8!z+1g5nox%t-+(mui+)'
...
ROOT_URLCONF = 'finalprojectJoseSaumat.urls'
...
WSGI_APPLICATION = 'finalprojectJoseSaumat.wsgi.application'
